...
namespace Veri_Tabanli_Secim_Projesi
{
    public partial class FrmGrafikler : Form
    {
        ...
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select ILCEAD from TBL_İLCE ", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("Select SUM(APARTİ), SUM(BPARTİ), SUM(CPARTİ), SUM(DPARTİ), SUM(EPARTİ) FROM TBL_İLCE", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * From TBL_İLCE where ILCEAD=@P1", baglanti);
